...
function alt_admin_footer () {
    echo '<span id="footer-thankyou">Desenvolvido por <strong>Agência KLS</strong></span>';
}
add_filter('admin_footer_text', 'alt_admin_footer');

// Mudar Logo do Wordpress
function meu_logo_login() {
    echo '<style  type="text/css"> h1 a {  background-image:url('.get_bloginfo('template_directory').'/img/logo.png)  !important; background-size: contain !important; width: 234px !important;} </style>';
}
