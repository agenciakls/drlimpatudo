                                    ...
                                    <table class="wp-list-table widefat fixed striped cadastros">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" id="assunto" class="manage-column column-assunto"> Assunto </th>
                                        ...
                                        <tbody id="the-list">
                                            ...
                                            foreach ($bookingList as $bookingCurrent) {
                                                $getSubject = $wpdb->get_results(
                                                    "SELECT * FROM form_contact_subject WHERE id='{$bookingCurrent->subject_id}'"
                                                );
                                                $titleSubject = (count($getSubject) == 1) ? $getSubject[0]->name : 'Padrão';
                                                ?>
                                                <tr id="post-20" class="iedit author-self level-0 post-20 type-page status-publish hentry">
                                                    ...
                                                    <td class="author column-author" data-colname="Assunto"><?php echo $titleSubject; ?></td>
