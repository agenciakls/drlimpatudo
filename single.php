...
<main class="single">
	<div class="container">
		...
		<a onclick="window.history.go(-1); return false;"><button type="button">Voltar</button></a><a href="<?php echo get_post_type_archive_link('blog'); ?>"><button type="button">Ver outros artigos</button></a>
